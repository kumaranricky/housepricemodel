...
## OUTPUT:
![output](./img/training.jpg)
![output](./img/prediction.jpg)
![output](./img/predictionlab.jpg)
![output](./img/traininglab.jpg)

## RESULT:
Thus, the websites:http://kumaran.student.saveetha.in:8000/HouseModelTraining/ and http://kumaran.student.saveetha.in:8000/HouseModelPrediction/ successfully displays the house price pridiction and house model training.